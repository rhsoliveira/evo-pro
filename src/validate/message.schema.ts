...
export const sendMessageAnyTypeSchema: JSONSchema7 = {
  $id: v4(),
  type: 'object',
  properties: {
    message: {
...
export const paymentOrderMessageSchema: JSONSchema7 = {
  $id: v4(),
  type: 'object',
  properties: {
    number: { ...numberDefinition },
    ...
    paymentSettings: {
      ...
      items: {
        ...
        properties: {
          type: {
            type: 'string',
            enum: ['pix_static_code', 'boleto', 'cards'],
          },
          pix_static_code: {
            type: 'object',
            properties: {
              key: { type: 'string' },
              key_type: { type: 'string', enum: ['PHONE', 'EMAIL', 'CPF', 'CNPJ', 'EVP'] },
  ...
  required: ['number', 'paymentSettings'],
};
