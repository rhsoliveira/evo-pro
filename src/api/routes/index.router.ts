...
router
  ...
  .get('/', async (req, res) => {
    // const redirectUrl = String(configService.get<string>('X_CUSTOM_REDIRECT_BASE_URL_TO_MANAGER') || '');

    // if (redirectUrl && redirectUrl !== '' && redirectUrl?.toLowerCase().startsWith('http')) {
