...
export class SendMessageController {
  ...
  public async sendPaymentOrder({ instanceName }: InstanceDto, data: SendPaymentOrderDto) {
    return await this.waMonitor.waInstances[instanceName].paymentOrderMessage(data);
  }
  ...
  public async sendMessageAnyType({ instanceName }: InstanceDto, data: SendMessageAnyType) {
    return await this.waMonitor.waInstances[instanceName].sendMessageAnyType(data);
  }
